...
def download_stock(ticker='SPY', start_date='2000-01-01', end_date='2019-01-01'):
...
def get_all_stocks(ticker_list=['SPY', 'GOOG'], start_date='2000-01-01', end_date='2019-01-01'):
